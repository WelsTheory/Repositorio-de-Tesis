#
# File: Ejemplo_de_Programa_principal.mk
#
#--------------------------------------------------------------
...
MAKECMD          = "C:/Program Files/MATLAB/R2014a/bin/win64/gmake"
SHELL            = cmd
HOST             = PC
#HOST            = ANY
BUILD            = yes
...
#
MODEL                   = Ejemplo_de_Programa_principal
MODULES                 = Ejemplo_de_Programa_principal_main.c MCHP_ADC1_Interrupt.c MCHP_UART1_Interrupt.c rtGetInf.c rtGetNaN.c rt_nonfinite.c 
#MODULES_OBJ            = Ejemplo_de_Programa_principal_main.obj MCHP_ADC1_Interrupt.obj MCHP_UART1_Interrupt.obj rtGetInf.obj rtGetNaN.obj rt_nonfinite.obj 
MAKEFILE                = Ejemplo_de_Programa_principal.mk
MATLAB_ROOT             = C:/Program Files/MATLAB/R2014a
ALT_MATLAB_ROOT         = C:/PROGRA~1/MATLAB/R2014a
MASTER_ANCHOR_DIR       = 
START_DIR               = D:/Tesis/Repositorio-de-Tesis
S_FUNCTIONS             = 
S_FUNCTIONS_LIB         = 
NUMST                   = 1
NCSTATES                = 0
COMPUTER                = PCWIN64
BUILDARGS               =  GENERATE_ASAP2=0 MCHP_AUTO_FLASH=0 MCHP_MULTITHREAD_COMPILATION=1
MULTITASKING            = 0
INTEGER_CODE            = 0
MAT_FILE                = 0
ONESTEPFCN              = 1
...
MODELREFS                 = 
MODELLIB                  = Ejemplo_de_Programa_principallib_lib.a
MODELREF_LINK_LIBS        = 
MODELREF_LINK_RSPFILE     = Ejemplo_de_Programa_principal_ref.rsp
MODELREF_INC_PATH         = 
...
GCCPATH	= C:/PROGRA~2/MICROC~1/xc16/v1.35/bin
ifeq ($(strip $(GCCPATH)),)
	CC   = $(GCC1)
	CPP  = $(GCC1)
	LD   = $(GCC1)
...
LINKER_SCRIPT 	= "p33FJ128MC802.gld"
PIC_LIB 		= 
PIC_INCLUDES 	= 
PIC_REF 		= 33FJ128MC802
...
# Additional info : PICREF{33FJ128MC802} PROGRAMMER{}
...
#
ADD_INCLUDES = \
	-I"$(START_DIR)/Ejemplo_de_Programa_principal.X" \
	-I"$(START_DIR)" \
	-I"$(START_DIR)/Framework" \
...
#ASM_OPTIM_SRCS = 
#
#ASM_OPTIM_SRCS += $(wildcard $(START_DIR)/Ejemplo_de_Programa_principal.X/*.s) 
#ASM_OPTIM_SRCS += $(wildcard $(START_DIR)/*.s) 
#ASM_OPTIM_SRCS += $(wildcard $(START_DIR)/Framework/*.s) 
