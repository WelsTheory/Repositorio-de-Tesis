...
MAKECMD          = "C:/Program Files/MATLAB/R2017a/bin/win64/gmake"
SHELL            = cmd
HOST             = PC
#HOST            = ANY
BUILD            = yes
...
#
MODEL                   = hola_dspic
MODULES                 = MCHP_ADC1_Interrupt.c MCHP_UART1_Interrupt.c hola_dspic_data.c hola_dspic_main.c rtGetInf.c rtGetNaN.c rt_nonfinite.c
#MODULES_OBJ            = MCHP_ADC1_Interrupt.obj MCHP_UART1_Interrupt.obj hola_dspic_data.obj hola_dspic_main.obj rtGetInf.obj rtGetNaN.obj rt_nonfinite.obj 
MAKEFILE                = hola_dspic.mk
MATLAB_ROOT             = C:/Program Files/MATLAB/R2017a
ALT_MATLAB_ROOT         = C:/PROGRA~1/MATLAB/R2017a
MASTER_ANCHOR_DIR       = 
START_DIR               = E:/Filtros_Tarjeta
S_FUNCTIONS             = 
S_FUNCTIONS_LIB         = 
NUMST                   = 1
NCSTATES                = 0
COMPUTER                = PCWIN64
BUILDARGS               =  ISPROTECTINGMODEL=NOTPROTECTING GENERATE_ASAP2=0 MCHP_AUTO_FLASH=0 MCHP_MULTITHREAD_COMPILATION=1
MULTITASKING            = 0
INTEGER_CODE            = 0
MAT_FILE                = 0
ONESTEPFCN              = 1
...
MODELREFS                 = 
MODELLIB                  = hola_dspiclib_lib.a
MODELREF_LINK_LIBS        = 
MODELREF_LINK_RSPFILE     = hola_dspic_ref.rsp
MODELREF_INC_PATH         = 
...
LINKER_SCRIPT 	= "p33FJ32MC202.gld"
PIC_LIB 		= 
PIC_INCLUDES 	= 
PIC_REF 		= 33FJ32MC202
...
# Additional info : PICREF{33FJ32MC202} PROGRAMMER{}
...
#ASM_OPTIM_SRCS += $(wildcard $(START_DIR)/hola_dspic.X/*.s) 
