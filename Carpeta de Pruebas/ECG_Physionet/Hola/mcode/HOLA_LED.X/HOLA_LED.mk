...
#
MODEL                   = HOLA_LED
MODULES                 = HOLA_LED_main.c MCHP_ADC1_Interrupt.c MCHP_UART1_Interrupt.c rtGetInf.c rtGetNaN.c rt_nonfinite.c 
#MODULES_OBJ            = HOLA_LED_main.obj MCHP_ADC1_Interrupt.obj MCHP_UART1_Interrupt.obj rtGetInf.obj rtGetNaN.obj rt_nonfinite.obj 
MAKEFILE                = HOLA_LED.mk
...
MODELREFS                 = 
MODELLIB                  = HOLA_LEDlib_lib.a
MODELREF_LINK_LIBS        = 
MODELREF_LINK_RSPFILE     = HOLA_LED_ref.rsp
MODELREF_INC_PATH         = 
...
#ASM_OPTIM_SRCS = 
#
#ASM_OPTIM_SRCS += $(wildcard $(START_DIR)/HOLA_LED.X/*.s) 
