...
#ifndef RTW_HEADER_Programa_DSPIC_h_
#define RTW_HEADER_Programa_DSPIC_h_
#include <math.h>
#include <string.h>
#include <stddef.h>
#ifndef Programa_DSPIC_COMMON_INCLUDES_
# define Programa_DSPIC_COMMON_INCLUDES_
#include "rtwtypes.h"
#endif                                 /* Programa_DSPIC_COMMON_INCLUDES_ */

#include "Programa_DSPIC_types.h"
...
typedef struct {
   ...
   */
  real32_T pooled2[41];
} ConstP_Programa_DSPIC_T;

/* Block signals and states (auto storage) */
extern DW_Programa_DSPIC_T Programa_DSPIC_DW;

/* Constant parameters (auto storage) */
extern const ConstP_Programa_DSPIC_T Programa_DSPIC_ConstP;

/* Model entry point functions */
extern void Programa_DSPIC_initialize(void);
extern void Programa_DSPIC_step(void);
 ...
 *
 * '<Root>' : 'Programa_DSPIC'
 * '<S1>'   : 'Programa_DSPIC/Compare To Constant'
 * '<S2>'   : 'Programa_DSPIC/Compare To Constant1'
 * '<S3>'   : 'Programa_DSPIC/Compare To Constant2'
 * '<S4>'   : 'Programa_DSPIC/Digital Output'
 * '<S5>'   : 'Programa_DSPIC/Digital Output1'
 * '<S6>'   : 'Programa_DSPIC/Digital Output2'
 */
#endif                                 /* RTW_HEADER_Programa_DSPIC_h_ */
