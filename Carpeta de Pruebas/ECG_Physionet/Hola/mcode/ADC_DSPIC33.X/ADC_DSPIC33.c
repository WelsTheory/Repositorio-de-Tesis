...
void ADC_DSPIC33_step(void)
{
   ...
   */
  ADC_DSPIC33_DW.A = ADC_DSPIC33_DW.U1Rx;
  ...
  rtb_FIR10 = (real32_T)ldexp(rtb_FIR10, -4);

  /* DataTypeConversion: '<Root>/Data Type Conversion4' */
  rtb_FIR10 = (real32_T)floor(rtb_FIR10);
  if (rtIsNaNF(rtb_FIR10) || rtIsInfF(rtb_FIR10)) {
    rtb_FIR10 = 0.0F;
  } else {
    rtb_FIR10 = (real32_T)fmod(rtb_FIR10, 256.0F);
  }

  ADC_DSPIC33_DW.DataTypeConversion4 = (uint8_T)(rtb_FIR10 < 0.0F ? (int16_T)
    (uint8_T)-(int8_T)(uint8_T)-rtb_FIR10 : (int16_T)(uint8_T)rtb_FIR10);
